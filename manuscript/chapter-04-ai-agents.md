...
[^agent-reliability]: CAIA (Crypto AI Agent Benchmark) tested 17 AI models on 178 high-stakes financial tasks requiring agents to distinguish truth from manipulation. Results: 28% accuracy without tools, plateauing at 67.4% with tools versus 80% human baseline. Key finding: "fundamental lack of skeptical reasoning" - agents are easily misled by manipulation and confidently hallucinate critical data. Dai, Zeshi, et al., "When Hallucination Costs Millions: Benchmarking AI Agents in High-Stakes Adversarial Financial Markets," arXiv:2510.00332 (September 2025), <https://arxiv.org/abs/2510.00332>; OpenAI's own benchmark results (May 2025) show o-series reasoning models hallucinate 33-79%: on PersonQA (public figures), o3 hallucinated 33%, o4-mini 48%; on SimpleQA (short factual questions), o3 hallucinated 51%, o4-mini 79%. See MIT Technology Review, "Don't let hype about AI agents get ahead of reality" (July 2025), <https://www.technologyreview.com/2025/07/03/1119545/dont-let-hype-about-ai-agents-get-ahead-of-reality/>, analyzing systematic failures in production agent deployments including loop failures, tool selection errors, and memory limitations.
