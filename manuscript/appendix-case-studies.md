...
- **Chapter:** [8](#chapter-8-myth-demos-equal-production-ready-reality-the-vibe-coding-gap)
...
- **Note:** This represents an ongoing security pattern rather than a single incident. The $20K OpenAI bill example in [Chapter 8](#chapter-8-myth-demos-equal-production-ready-reality-the-vibe-coding-gap) illustrates a common occurrence affecting developers using AI pair programming tools.
...
- **Chapter:** [4](#chapter-4-myth-ai-agents-are-autonomous-reality-theyre-scripted-workflows-with-llm-calls)
